        ...
        <div className="flex justify-between items-center mt-2">
          ...
          <div className=" justify-between flex items-center p-1">
            <input
              ...
              className="rounded-lg text-center max-w-[150px] p-2 border-none focus:ring-transparent shadow-lg focus:outline-none"
            />
          </div>
        </div>

        <div className="grid grid-cols-3 mt-8 gap-2 justify-items-center mb-14">
          {jodiDigits
            .slice()
            ...
            .map((digit) => {
              ...
              return (
                <div
                  key={digit}
                  className="relative bg-green-500 pt-6 pb-6 pl-8 pr-8 rounded-md text-white font-semibold text-center items-center"
                  onClick={() => handleNumberClick(digit)}
                >
                  {digit}

                  {existingBid && (
                    <span className="absolute right-0 bottom-0  bg-white rounded w-full border border-green-500 text-black font-bold text-sm flex justify-center items-center">
        ...
        <div className="fixed bottom-0 left-0 right-0 border-t bg-white shadow-md p-2 pl-4 pr-4">
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="p-3 font-medium bg-green-500 text-white flex items-center gap-2 text-[14px] rounded"
            >
              <FaArrowUpLong />
              Submit Bids
            </button>
