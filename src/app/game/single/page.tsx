        ...
        <>
          ...
          <div className="flex justify-between items-center mt-1">
            ...
            <div className="rounded-md p-1">
              <input
                ...
                className="rounded-lg  shadow-md text-center p-2 max-w-[150px] border-none focus:ring-transparent focus:outline-none"
              />
            </div>
          </div>
          ...
          <div className="flex justify-end items-center mt-2 text-end">
            <button
              ...
              className="bg-green-500 min-w-[154px] font-medium p-2 text-sm text-white rounded flex items-center justify-center gap-2"
            >
              <FaPlus />
              Add Bid
            </button>
            ...
            <table className="min-w-full bg-green-500  table-auto text-center">
              <thead>
                <tr className="border-b text-white text-sm">
                  <th className="p-2 font-normal">Ank</th>
