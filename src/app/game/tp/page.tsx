...
import { triplePanaDigits } from '@/utils/numbers';
  ...
  return (
    <>
      <div className="mt-12 p-4">
        ...
        <div className="grid grid-cols-3 mt-4 gap-2 justify-items-center mb-12 ">
          {triplePanaDigits
            .slice()
